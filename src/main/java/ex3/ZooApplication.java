...
public class ZooApplication {
	...
	public static void main(String[] args) {
		...
		zoo.addAnimal(new Animal("Lion", TypeAnimal.MAMMIFERE, CategorieComportement.CARNIVORE));
		zoo.addAnimal(new Animal("Panthère", TypeAnimal.MAMMIFERE, CategorieComportement.CARNIVORE));
		zoo.addAnimal(new Animal("Requin blanc", TypeAnimal.POISSON, CategorieComportement.CARNIVORE));
